...
```
![](https://github.com/JUBJIBPIYAPATH/LAB-03/blob/master/333.PNG?raw=true)
ผลการรันโปรแกรมเป็นการบอกตำแน่งของลูกศรเมาส์ว่าตอนนั้นเราชี้อยู่ที่ตำแหน่งใด
##คำถาม 
1.	นักศึกษาพบปัญหาในการคอมไพล์โปรแกรมหรือไม่ ถ้าเจอให้บอกที่ผิดและแนวทางการแก้ไข
```
ตอบ ไม่พบปัญหาในการคอมไพล์ครับ
```
